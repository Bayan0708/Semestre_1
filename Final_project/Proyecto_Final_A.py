...
def vMenuMate ():
            ...
            def Calcular ():
                ...
                if a==0:
                    ...
                    if discriminante >= 0:
                        ...
                        mensaje = "Las raíces complejas son: x1 = " + str(x1) + "  y   x2 = "   + str(x2)
                        MensaEcuaciones2doGrado.config(text = mensaje) 
                        f = f"{a}*x**2+{b}*x+{c}"
                        n = 10000 # x_f - x_0
                        m = (x_f-x_i)/n
                        ...
                        subfigura = figura.add_subplot (111)
                        subfigura.plot (listax, listay)
                        subfigura.set(xlabel = 'Eje X', ylabel = 'Eje Y', title = "Función de tu ecuación de segundo grado")
                        subfigura.legend ()
                        subfigura.grid ()
                        subfigura.set_ylim(y_i,y_f)
                        canvas = FigureCanvasTkAgg (figura, master = ventanaEcuaciones2doGrado)
    ...
    def vCalculoIntegral ():
        ...
        def meSimpson1 ():
            ...
            ventanaMetodoSimpson1.title("Método Simpson 1/3 Compuesto")
            def Calcular ():
