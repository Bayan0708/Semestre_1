...
def Calcular ():
    ...
    subfigura.plot (lista,lista2,'indigo')
...
Simpsonestructura = Label (ventanaMetodoSimpson1, text = "Este programa aproxima el área bajo la curva de intervalos de funciones, usando el Método Trapezoidal Compuesto", font = ("Courier", 14))
